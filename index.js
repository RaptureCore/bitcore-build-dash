...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-rapture/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = browserifyPath + ' --require ./index.js:' + fullname + ' --external bitcore-lib-rapture -o ' + fullname + '.js';
    } else {
      browserifyCommand = browserifyPath + ' --require ./index.js:bitcore-lib-rapture -o bitcore-lib-rapture.js';
    }
